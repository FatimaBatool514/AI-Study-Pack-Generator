...
with st.sidebar:
    ...
    st.markdown("1. 🎯 **Planner**: Generates structured blueprint")
    st.markdown("2. 📝 **Generator**: Builds study content & quiz")
    st.markdown("3. 🔍 **Reviewer**: Audits quality & compliance")
    st.markdown("4. ✨ **Refiner**: Polishes final markdown layout")
...
with col_right:
    goal = st.text_input("Learning Goal / Outcome:", placeholder="e.g., Prepare for introductory computer science exam")
