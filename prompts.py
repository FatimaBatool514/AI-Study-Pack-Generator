"""
Prompt templates used across multi-stage AI workflow.
Separating prompts allows easy fine-tuning without modifying workflow code logic.
"""
...
- Completeness across all requested modules
- Appropriateness for the specified audience level
...
Formatting Rules:
- Ensure clean Markdown syntax with proper heading levels (# ## ###).
- Use clear bullet points, bold emphasis for key terminology, and blockquotes for highlights.
- Make flashcards and quiz sections visually distinct and easy to read.
"""
